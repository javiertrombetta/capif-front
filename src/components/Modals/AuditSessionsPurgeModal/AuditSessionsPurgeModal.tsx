...
const AuditSessionsPurgeModal: FC<{ onCloseModal: () => void }> = ({
  onCloseModal,
}) => {
  return (
    <div
    ...
    >
      ...
      <div className="w-[100%] pr-[1rem] pl-[1rem] flex flex-col items-center gap-[2rem] justify-center">
        <p className="text-black font-bold text-[1.3rem] text-center w-[90%]">
          ¿Estás seguro de que deseas depurar todos los registros de sesiones?
        </p>
...
export default AuditSessionsPurgeModal;
